...
export default function AboutSection() {
  return (
    <Section id="quienes-somos" className="bg-surface py-14 sm:py-16 md:py-20">
        ...
        <Reveal delay={0.08}>
          <div className="space-y-5">
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="flex min-h-[210px] items-end rounded-[28px] border border-dashed border-border bg-surface-soft p-5 sm:min-h-[240px]">
                <p className="text-xs font-semibold uppercase tracking-[0.18em] text-muted">
                  Espacio para imagen de equipo
                </p>
              </div>
              <div className="flex min-h-[210px] items-end rounded-[28px] border border-dashed border-border bg-surface-soft p-5 sm:min-h-[240px]">
                <p className="text-xs font-semibold uppercase tracking-[0.18em] text-muted">
                  Espacio para imagen de proyecto
                </p>
              </div>
            </div>
            ...
            {BLOCKS.map((block) => (
              <div key={block.title} className="rounded-[28px] border border-border bg-surface p-6 sm:p-7">
